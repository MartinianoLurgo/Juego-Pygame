...
def show_go_screen():
    ...
    draw_text(screen, "Mueve Tu Nave Espacial", 27, WIDTH // 2, HEIGHT // 2 - 30)
    draw_text(screen, "Evita los Asteroides", 27, WIDTH // 2, HEIGHT // 2)
    draw_text(screen, "Usando las Teclas <- ->", 27, WIDTH // 2, HEIGHT // 2 + 30)
    draw_text(screen, "Dispara con la Barra Espaciadora", 27, WIDTH // 2, HEIGHT // 2 + 60)
